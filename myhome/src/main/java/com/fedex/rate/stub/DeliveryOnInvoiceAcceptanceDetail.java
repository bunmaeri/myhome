...
public class DeliveryOnInvoiceAcceptanceDetail  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v20", "DeliveryOnInvoiceAcceptanceDetail"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v20", "TrackingId"));
