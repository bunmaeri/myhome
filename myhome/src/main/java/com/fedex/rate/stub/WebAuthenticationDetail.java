...
public class WebAuthenticationDetail  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v20", "WebAuthenticationDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("parentCredential");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v20", "ParentCredential"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v20", "WebAuthenticationCredential"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("userCredential");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v20", "UserCredential"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v20", "WebAuthenticationCredential"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
