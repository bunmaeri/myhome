...
public class RateServiceLocator extends org.apache.axis.client.Service implements com.fedex.rate.stub.RateService {
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://fedex.com/ws/rate/v20", "RateService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://fedex.com/ws/rate/v20", "RateServicePort"));
        }
