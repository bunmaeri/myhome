            ...
            <div class="col-md-9 col-md-push-1">
                <div class="my-account">
                    ...
                    <form action="/account/address/add.dr" method="post" id="form-validate">
					    ...
					    <h5><a class="button button-white button-small" href="/account/address/new/223.dr"><img src="/image/flag-us.png" title="English" style="width:20px;height:auto;"> 미국 주소 추가</a></h5>
					    </c:if> --%>
                                ...
                                <li>
                                    ...
                                    <div class="row">
										<div class="col-md-12 input-box" style="padding-left:10px;padding-right:10px;">
										    ...
										    <input type="text" id="postcode" name="postcode" value="${map.postcode}" placeholder="예) 04515" class="input-text required-entry" style="display:inline;max-width:40%;" readonly/>
									    </div>
								    </div>
								</li>
				                <li>
					    ...
					    <div class="buttons-set form-buttons">
					        ...
					        <a class="button button-white button-default" href="/account/address.dr">주소록으로 이동</a>
					    </div>
