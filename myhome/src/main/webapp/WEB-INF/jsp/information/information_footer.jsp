			   ...
			   <div class="row">
			     ...
			     <div class="col-md-4 col-md-push-0">
			         <ul class="product-list-subset">
			             <li><h5 style="font-size:16px;"><a href='/information/privacy-policy.dr'>개인정보보호정책</a></h5></li>
			             <li><h5 style="font-size:16px;"><a href='/information/return-policy.dr'>반품정책</a></h5></li>
			             <li><h5 style="font-size:16px;"><a href='/information/terms-of-use.dr'>이용약관</a></h5></li>
			         </ul>
			      </div>
			    </div>
			</div>
