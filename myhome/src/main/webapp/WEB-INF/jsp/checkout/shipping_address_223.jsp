            ...
            <div class="col-md-9" style="padding-left:0px;padding-right:0px;">
                <div class="my-account">
                    <form action="/account/address/add.dr" method="post" id="form-validate">
					    ...
					    <h5><a class="button button-white button-small" href="/checkout/shipping/address/new/113.dr"><img src="/image/flag-kr.png" title="한국어" style="width:20px;height:auto;"> 한국 주소 추가</a></h5>
					    </c:if> --%>
					    ...
					    <div class="buttons-set form-buttons">
					        ...
					        <a class="button button-white button-default" href="/checkout/shipping/address.dr">GO BACK</a>
					    </div>
